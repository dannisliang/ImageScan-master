...
public abstract class BaseFragment extends Fragment {
	...
	protected void initNormalData() {
		title = (TextView) rootView.findViewById(R.id.is_title);
		chooseOk = (Button) rootView.findViewById(R.id.is_choose_ok);
		...
		rootView.findViewById(R.id.is_back).setOnClickListener(new OnClickListener() {
